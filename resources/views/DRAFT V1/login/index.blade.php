...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>NotarisPRO | User Login</title>
	...
	<body class=" login">
		...
		<div class="logo">
			<a href="index.html">
				<img src="{!!url('/metronic/assets/pages/img/logo-big-white.png')!!}" style="height: 17px;" alt="" />
			</a>
		</div>
		<!-- END LOGO -->
		<!-- BEGIN LOGIN -->
		...
		<div class="copyright hide"> 2017 © Thunderlab.ID </div>
		<!-- END LOGIN -->
		<!--[if lt IE 9]>
